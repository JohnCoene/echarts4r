...
# TODO review
# test_that("echarts4rBox sets default type to bar", {
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, type = "area")
#
#   expect_equal(result$options$series[[1]]$type, "bar")
# })
#
...
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, color = "#ff0000", text_color = "#00ff00", background_color = "#0000ff")
#
...
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, text = "Main Title", subtext = "Subtitle")
#
...
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, title_args = list(left = "center", top = 10))
#
...
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, tooltip = list(trigger = "item"))
#
...
#   df <- data.frame(x = 1:5, y = 6:10)
#
#   result <- echarts4rBox(df, x, y, smooth = TRUE)
#
