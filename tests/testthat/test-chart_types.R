...
test_that("e_river plot has the good data structure and type", {
  ...
  expect_equal(
    plot$x$opts$series[[1]]$data, 
    list(list(c("2020-10-08"), c("0.2655087"), c("apples")), list(c("2020-10-09"), c("0.3721239"), c("apples")), list(c("2020-10-10"), c("0.5728534"), c("apples")), 
...
test_that("e_radar plot has the good data structure and type", {
  ...
  expect_equal(
    plot$x$opts$series[[1]]$data, 
    list(list(value = c(2.062035, 2.488496, 3.291413, 4.632831, 1.806728), name = "radar"),
