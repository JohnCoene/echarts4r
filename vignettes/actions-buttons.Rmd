...
<span class="label label-warning"><i class="fa fa-warning"></i></span> Still under development, please report issues.
...
iris %>% 
  ...
  e_line(Petal.Length) %>% 
  e_datazoom() %>% 
  e_highlight(series.name = "setosa", btn = "highlightButton") %>% # highlight action
  e_zoom( # zoom action
    dataZoomIndex = 0,
    startValue = 4,
    endValue = 6,
...
- `e_toolbox_restore` to restore the toolbox.
