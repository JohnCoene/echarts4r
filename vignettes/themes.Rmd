...
The method above, however, registers the theme every time the chart is drawn, if displaying multiple charts this can leads to large html files or slower Shiny application. There is thus also the function `e_register_theme` to register the custom theme once, and subsequently use it.
...
ui <- fluidPage(
  e_register_theme('{"color":["#ff715e","#ffaf51"]}', name = "myTheme"),
