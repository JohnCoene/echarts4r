...
The above is an admittedly small theme, if you want to create a large custom theme, download the JSON from the [theme builder](http://echarts.baidu.com/download-theme.html) and use it, `e_theme_custom` and `e_register_theme` both detect the json file and read it in.
