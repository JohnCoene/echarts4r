...
The above plot one line (`e_line`) for each group (`group_by`). _At one exception_, when `timeline` is set to `TRUE` when the chart is initialised with `e_charts`. In the latter case each group is used as a step of the timeline.
