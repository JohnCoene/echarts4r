...
Chart types are not only applicable to the standard 2d cartesian coordinate system. Most chart types will default to the `cartesian2d` coordinate system but may be applied to others.
