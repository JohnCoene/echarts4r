...
By default `echarts4r` passes the entirety of your `data.frame` to the visualisation and, the document or app in which it is, which may be too heavy. Use `e_clean` at the end of your `%>%` to remove it.
