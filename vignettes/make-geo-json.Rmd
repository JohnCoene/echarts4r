...
Note that you can then combine maps with `raster::union(map1, map2)`. Then the `SpatialPolygonsDataFrame` into `GeoJSON` with `geojsonio`: _this will take a long time as the map is very detailed_.
