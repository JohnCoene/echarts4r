...
You can also install the development version of echarts4r with `devtools` or `remotes` from Github, Bitbucket or Coding. The latter is specifically for China, as the package is large download from Mainland can be long from outside the firewall.
