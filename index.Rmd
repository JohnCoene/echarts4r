  ...
  div(
    ...
    div(
      ...
      div(
        ...
        div(
          class = "col-md-2",
          tags$i(class = "fa fa-warning fa-4x", style = "color:#ff4136;")
        ),
        div(
          class = "col-md-10",
          code("echarts4r"), ", by default, passes the entirety of your data to the visualisation, which may lead to large files.",
          "Use", code("e_clean"), "at the end of your", code("%>%"), "to remove it all."
        )
      )
    )
  ),
