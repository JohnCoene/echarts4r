...
Group <span class="label label-default">new</span>
</div>
<div class="panel-body">
`echarts4r` now understands `dplyr::group_by` in order to comply with the [tidy data](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html) concept; the package now works much better with *long* datasets. See [get started guide](articles/get_started) or the various examples in the functions' documentation or the [gallery](article/gallery).
</div>
</div>
